...
if not funnel_df.empty:
    fig = px.bar(
        ...
        color="stage",
        color_discrete_sequence=["#818cf8", "#6366f1", "#4f46e5", "#4338ca", "#3730a3", "#16a34a", "#dc2626"],
    )
...
with left:
    ...
    fig2 = go.Figure()
    fig2.add_trace(go.Scatterpolar(r=values + [values[0]], theta=categories + [categories[0]], fill="toself", fillcolor="rgba(99,102,241,0.2)", line_color="#6366f1"))
